...
let captchaText = "";
let operators = [['+', function (a, b) { return a + b; }, 'plus'], ['-', function (a, b) { return a - b; }, 'minus']];
...
function getDOMForCaptchaElements() {
    return `<div class="canvas-and-btn-container">
                ...
                <div class="icon-container" title="Reload Captcha" onclick="refresh()">
                ...
                <div class="icon-container" title="Read Captcha" onclick="playAudio()">
